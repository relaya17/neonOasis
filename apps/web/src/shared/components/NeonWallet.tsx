...
const TX_LABELS: Record<string, { label: string; emoji: string }> = {
  ...
  win: { label: 'פרס מיומנות', emoji: '🏆' },
  bet: { label: 'דמי כניסה לתחרות', emoji: '🎯' },
  ...
  withdrawal: { label: 'מימוש פרס', emoji: '🏦' },
  p2p_transfer: { label: 'פרס משחק', emoji: '🏆' },
  escrow_hold: { label: 'הפקדת תחרות', emoji: '🔒' },
  escrow_release: { label: 'שחרור הפקדה', emoji: '🔓' },
  backing_bet: { label: 'תמיכה בשחקן', emoji: '📣' },
  backing_payout: { label: 'תגמול תמיכה', emoji: '💰' },
  backing_share: { label: 'חלק מפרס', emoji: '🏆' },
